$(function () {
    ...
    setTimeout(function () {
        ...
        $('#modal_content .modal-header button').click(function () {
            sign_keyenter = false;
        });
...
var methods = {
    ...
    setStr: function () {
        ...
        tdStr = ' <td><div class="checkbox icheck-emerland">\n' +
            '                    <input type="checkbox" id="'+tarInp.eq(0).val()+'" value="'+tarInp.eq(0).val()+'"/>\n' +
            '                    <label for="'+tarInp.eq(0).val()+'"></label>\n' +
            '                    </div></td>';
        ...
        tdStr+= '<td><a href="#" class="edit">編輯</a> <a href="#" class="del">刪除</a></td>';
        setTimeout(function () {
             $('.del').click(function () {
                $(this).parents('tr').remove();
            });
